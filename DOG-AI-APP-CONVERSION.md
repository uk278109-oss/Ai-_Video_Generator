...
## Mascot
DOG AI uses the same custom dog mascot identity for the splash screen and loading states. Coding, image generation, authentication and general AI loading states use the dog animation rather than a generic spinner.
