...
import { Menu, Image as ImageIcon, List, Mic, Sparkles, Brain, UserCircle2, Code2 as Code2Icon } from "lucide-react";
...
export default function Home({ onOpenMenu, onNavigate }: HomeProps) {
  ...
  return <div className="home">
    ...
    {sent.length > 0 && <section className="conversation-preview"><div className="preview-label">You</div><div className="preview-message">{sent[sent.length - 1]}</div><div className="preview-placeholder"><Sparkles size={18}/> AI engine is ready for provider connection. Gemini/Grok will be connected securely next.</div></section>}
    ...
    <section className="hero-section">
      ...
      <p>Your account, conversations and preferences are ready.</p><div className="usage-chip"><Code2Icon /> Free coding limit: <strong>{codingLimit} requests / month</strong></div>
