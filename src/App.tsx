...
function Splash() {
  return <main className="splash"><DogLoader size={116} /><div className="splash-name">DOG AI</div><div className="splash-line" /></main>;
}
...
function AppShell() {
  ...
  if (loading) return <div className="loading-screen"><DogLoader size={76} label="Loading DOG AI…" /></div>;
